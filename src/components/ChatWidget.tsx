...
function BotAvatar() {
  return (
    <div className="w-7 h-7 rounded-full bg-gradient-to-br from-violet-600 to-indigo-600 flex items-center justify-center text-white text-xs font-bold flex-shrink-0 select-none">
      G
    </div>
  );
}
    ...
    <>
          ...
          <div className="border-t border-gray-200 px-3 py-3 flex-shrink-0 bg-white">
            ...
            <form onSubmit={handleSubmit} className="flex gap-2 items-center">
              ...
              <button
                ...
                aria-label="Send"
                className="w-8 h-8 bg-gradient-to-br from-violet-600 to-indigo-600 text-white rounded-full flex items-center justify-center hover:from-violet-700 hover:to-indigo-700 disabled:opacity-40 transition-all flex-shrink-0"
              >
                <svg
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <button
          ...
          className="w-14 h-14 bg-gradient-to-br from-violet-600 to-indigo-600 hover:from-violet-700 hover:to-indigo-700 text-white rounded-full shadow-lg shadow-indigo-500/40 flex items-center justify-center transition-all duration-200 hover:scale-105 hover:shadow-xl hover:shadow-indigo-500/50 active:scale-95"
        >
          {open ? (
